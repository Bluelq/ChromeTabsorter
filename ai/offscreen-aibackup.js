// Offscreen AI Processor with Transformers.js
// Handles semantic embeddings for tab grouping

// Access the transformers library from the global scope (loaded via CDN)
...
if (env) {
  ...
  env.localURL = chrome.runtime.getURL('ai/models/');
...
class AIProcessor {
    ...
    async initialize() {
        ...
        try {
            ...
            // Use a smaller, faster model for browser environment
...
console.log('TabSorter AI Offscreen processor loaded');
